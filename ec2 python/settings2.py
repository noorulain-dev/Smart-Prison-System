...
CLIENT_ID = "cloud_sub_settings_2"
...
while True:
    ...
    mycursor.execute("SELECT buzz, openDoor FROM cell WHERE cellID = 2")
    ...
    if(buzzerVal != result[0]):
        ...
        mycursor.execute("UPDATE cell SET buzz = 0 WHERE cellID = 2");
        mydb.commit()
